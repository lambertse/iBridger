...
std::string ServiceBase::name() const { return name_; }

std::vector<std::string> ServiceBase::methods() const { return method_names_; }
...
void ServiceBase::register_method(const std::string& method,
                                  rpc::MethodHandler handler) {
