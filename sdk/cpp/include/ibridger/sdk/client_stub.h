...
class ClientStub {
 public:
  ...
  /// Server-side NOT_FOUND/INTERNAL are returned as
  /// std::errc::no_such_file_or_directory / std::errc::io_error respectively.
  template <typename TReq, typename TResp>
  std::pair<TResp, std::error_code> call(const std::string& service,
